  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[rgb(66,100,160)] via-[rgb(46,80,140)] to-[rgb(26,60,120)]">
      ...
      <div className="relative">
        {/* Hero Section - Increased container padding */}
        <main className="container mx-auto px-8 lg:px-16 pt-28 pb-16">
          <div className="grid gap-4 lg:gap-12 lg:grid-cols-12 items-center">
            {/* Text Content */}
            <motion.div
              className="lg:col-span-6 space-y-8 text-center lg:text-left px-4 lg:px-8"
            ...
            >
              ...
              {/* Subheading */}
              <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-white/90 leading-snug">
              ...
              <div className="flex justify-center lg:justify-start">
                <RegisterDialog>
                  <Button size="lg" className="bg-sky-500 hover:bg-sky-600 transition-colors px-20 py-8 rounded-xl scale-105 hover:scale-110 transform duration-300">
                    <span className="text-white font-bold text-3xl flex items-center gap-4">
                      Watch Webinar NOW! <ChevronRight className="h-10 w-10 stroke-[3]" />
                    </span>
                  </Button>
                </RegisterDialog>
              </div>
            ...
            <motion.div
              className="lg:col-span-6 relative px-4 lg:px-8"
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
            >
              <div className="relative max-w-[90%] lg:max-w-[100%] mx-auto">
        ...
        <section className="bg-white pt-0 pb-24 relative">
          <div className="container mx-auto px-8 lg:px-16 relative z-10">
            <motion.div
              className="max-w-4xl mx-auto bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] p-16"
            ...
            >
              <div className="space-y-16">
                ...
                <div className="flex justify-center pt-8">
                  <RegisterDialog>
                    <Button size="lg" className="bg-sky-500 hover:bg-sky-600 transition-all px-16 py-7 rounded-xl w-[380px] shadow-xl hover:shadow-2xl scale-105 hover:scale-110 transform duration-300">
